...
const resetPasswordTemplate = (YOUR_RESET_PASSWORD_LINK: string, YOUR_COMPANY_LOGO_URL?: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="${YOUR_RESET_PASSWORD_LINK}" class="btn">Reset password</a>
        </div>
        <div class="footer">
            <p>If you did not create an account, no further action is required.</p>
        </div>
...
export { resetPasswordTemplate, confirmationTemplate };